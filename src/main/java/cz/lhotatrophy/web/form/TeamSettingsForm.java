...
public class TeamSettingsForm {
	...
	private TeamMember getTeamMember(
		...
		final AccommodationOfferEnum accommodationEnum = EnumUtils.decodeEnum(AccommodationOfferEnum.class, accommodation).orElse(AccommodationOfferEnum.NO);
		...
		member.addProperty("accommodation", accommodationEnum.name());
		return member;
	}
	...
	private TeamMember getTeamMember(final int number) {
		...
		switch (number) {
			case 1: {
				member = getTeamMember(name_1, friday_1, saturday_1, tshirt_1, accommodation_1);
				break;
			}
			case 2: {
				member = getTeamMember(name_2, friday_2, saturday_2, tshirt_2, accommodation_2);
				break;
			}
			case 3: {
				member = getTeamMember(name_3, friday_3, saturday_3, tshirt_3, accommodation_3);
				break;
			}
			case 4: {
				member = getTeamMember(name_4, friday_4, saturday_4, tshirt_4, accommodation_4);
				break;
			}
			case 5: {
				member = getTeamMember(name_5, friday_5, saturday_5, tshirt_5, accommodation_5);
				break;
			}
			default:
